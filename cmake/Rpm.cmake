...
if (LSB_RELEASE_EXEC AND RPMBUILD_EXEC)
  ...
  if (DIST_NAME)
    ...
    add_custom_target(rpm
      ...
      COMMAND ${CMAKE_COMMAND} -E copy qtgiphy-${QTGIPHY_VERSION_PACKAGE}.tar.xz ${RPMBUILD_DIR}/SOURCES/
      COMMAND ${RPMBUILD_EXEC} -ba ${CMAKE_SOURCE_DIR}/dist/unix/qtgiphy.spec
    )
